...
if __name__ == '__main__':
    ...
    # parser.add_argument('--train-file', type=str, default="../dataset/DIV2K_R0F0_QF10.h5")
    ...
    parser.add_argument('--log-dir', type=str,default="log/log_%s.txt"%testNum)
    ...
    fpLog = open("log/log_%s.txt"%testNum, 'w') # training loss check
    ...
    train_dataset = TrainDataset(setName = "DIV2K_R0F0_QF10")
